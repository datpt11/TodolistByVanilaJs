...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/components/button/button.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/components/button/button.js":[function(require,module,exports) {
"use strict";
...
function button(_ref) {
  var text = _ref.text,
      ...
      type = _ref.type,
      classCustom = _ref.classCustom,
      dataId = _ref.dataId;
  var sizeClassName = "btn--".concat(size);
  var colorClassName = "btn--".concat(color);
  if (type) return "\n      <button type=\"".concat(type, "\" class=\"btn ").concat(sizeClassName, " ").concat(colorClassName, " ").concat(classCustom, "\">").concat(text, "</button>\n    ");else return "\n      <button data-id=\"".concat(dataId, "\" class=\"btn ").concat(sizeClassName, " ").concat(colorClassName, " ").concat(classCustom, "\">").concat(text, "</button>\n    ");
}

var _default = button;
exports.default = _default;
},{"./button.scss":"src/components/button/button.scss"}],"src/components/todoInput/todoInput.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/components/todoInput/todoInput.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./todoInput.scss":"src/components/todoInput/todoInput.scss"}],"src/components/todoForm/todoForm.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/components/todoForm/todoForm.js":[function(require,module,exports) {
"use strict";
...
var _todoInput = _interopRequireDefault(require("../todoInput/todoInput"));

require("./todoForm.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var formTodo = function formTodo(_ref) {
  var buttonText = _ref.buttonText;
  return "\n    <form class=\"todo__form\">\n      ".concat((0, _todoInput.default)(), "\n      ").concat((0, _button.default)({
    text: buttonText,
    size: "large",
    color: "primary",
    type: "submit",
    classCustom: 'btn__submit'
  }), "\n    </form>\n  ");
};

var _default = formTodo;
exports.default = _default;
},{"../button/button":"src/components/button/button.js","../todoInput/todoInput":"src/components/todoInput/todoInput.js","./todoForm.scss":"src/components/todoForm/todoForm.scss"}],"src/app.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var _todoForm = _interopRequireDefault(require("./components/todoForm/todoForm"));
...
var _default = app;
exports.default = _default;
},{"./components/todoForm/todoForm":"src/components/todoForm/todoForm.js","./app.scss":"src/app.scss"}],"src/components/todoItem/todoItem.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/components/todoItem/todoItem.js":[function(require,module,exports) {
"use strict";
...
var todoItem = function todoItem(item, index) {
  return "\n    <li class=\"todo__item\">\n      <div class=\"todo__checkbox\">\n        <button data-id=".concat(item.id, " class=\"checkbox ").concat(item.isComplete ? "checked" : "", "\"></button>\n      </div>\n      <div class=\"todo__task\">\n        <p class=").concat(item.isComplete ? "todo--complete" : "", ">").concat(item.name, "</p>\n      </div>\n      <div class=\"todo__action\">\n        ").concat((0, _button.default)({
    text: "Edit",
    color: "secondary",
...
exports.default = _default;
},{"../button/button":"src/components/button/button.js","./todoItem.scss":"src/components/todoItem/todoItem.scss"}],"node_modules/uuid/dist/esm-browser/rng.js":[function(require,module,exports) {
"use strict";
...
var _todoItem = _interopRequireDefault(require("../todoItem/todoItem"));
...
var TodoList = /*#__PURE__*/function () {
  ...
  _createClass(TodoList, [{
    ...
    value: function _init() {
      ...
      this.todoListEl.addEventListener("click", function (e) {
        var currentNode = e.target;

        if (currentNode.classList.contains("btn__delete")) {
          var dataId = currentNode.getAttribute("data-id");
          currentNode.addEventListener("click", _this2.handleDelete(dataId));
        }
      });
      this.todoListEl.addEventListener("click", function (e) {
        var currentNode = e.target;
        ...
        if (currentNode.classList.contains("btn__edit")) {
          var dataId = currentNode.getAttribute("data-id");
          currentNode.addEventListener("click", _this2.handleEdit(dataId));
        }
      });
      this.todoListEl.addEventListener("click", function (e) {
        var currentNode = e.target;
...
exports.default = _default;
},{"../todoItem/todoItem":"src/components/todoItem/todoItem.js","uuid":"node_modules/uuid/dist/esm-browser/index.js"}],"data.js":[function(require,module,exports) {
"use strict";
...
},{"./styles.css":"src/styles.css","./app":"src/app.js","./components/TodoList/TodoList":"src/components/TodoList/TodoList.js","../data":"data.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
